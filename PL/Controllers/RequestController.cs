...
namespace PL.Controllers
{
    public class RequestController : Controller
    {
	    ...
	    public RequestController(RequestFacade requestFacade, UserFacade userFacade, ChatFacade chatFacade, GroupFacade groupFacade)
	    {
		...
		private List<InviteModel> AccHelper( ICollection<AccountDTO> searchResults=null, int? groupId = null, int? chatId = null)
	    {
			var user = userFacade.GetUserById(int.Parse(User.Identity.GetUserId()));
			...
			var list = new List<InviteModel>();
			accountList.ForEach(f => list.Add(new InviteModel { Account = f }));
		    return list;
	    }
